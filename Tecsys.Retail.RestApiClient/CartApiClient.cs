...
namespace Tecsys.Retail.RestApiClient
{
    public class CartApiClient: ApiClient, ICartApiClient
    {
        ...
        public async Task<HttpResponseMessage> AddCartItem(Model.ICartItemModel cartItemModel)
        {
        ...
        public async Task<ICartItemModel> CreateCartItem(string cartId, int productId)
        {
        ...
        public async Task<ICartItemModel> GetCartItem(string itemId)
        {
